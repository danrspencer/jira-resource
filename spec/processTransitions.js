...
describe('processTransitions', () => {
    ...
    it('can progress through multiple transitions', (done) => {
        ...
        nock(jira.url)
            ...
            .reply(200, { "expand": "transitions", "transitions": [ { "id": "51", "name": "Submit" } ] })
            .get('/rest/api/2/issue/' + issue.id + '/transitions/')
            .basicAuth({ user: jira.user, pass: jira.pass })
            .reply(200, { "expand": "transitions", "transitions": [ { "id": "69", "name": "Test" } ] })
            .get('/rest/api/2/issue/' + issue.id + '/transitions/')
            .basicAuth({ user: jira.user, pass: jira.pass })
            .reply(200, { "expand": "transitions", "transitions": [ { "id": "12",  "name": "Complete" }, { "id": "13",  "name": "Reject" } ] });
